...
{
	argc = 7;
	argv[1] = "detector"; argv[2] = "test";
	argv[3] = "..\\yolov3\\data\\voc.data";  
	argv[4] = "..\\yolov3\\cfg\\yolov3.cfg";
	argv[5] = "..\\yolov3\\cfg\\yolov3.weights";
	argv[6] = "..\\yolov3\\data\\kite.jpg";

    if(argc < 2){
        fprintf(stderr, "usage: %s <function>\n", argv[0]);
        return 0;
    }
	gpu_index = find_int_arg(argc, argv, "-i", 1);
